...
class AssistantChatResponse(BaseModel):
    session_id: str
    message: str
    response_type: Literal["greeting", "clarification", "confirmation_required", "action_pending", "action_completed", "recommendation", "comparison", "knowledge", "unsupported", "guardrail_blocked", "off_topic"] = "recommendation"
